     ...
     start: function (id) {
         ...
         if (!d.getElementById("EditAreaArroundInfos_" + id) && (eAs[id]["settings"]["debug"] || eAs[id]["settings"]["allow_toggle"])) {
             ...
             if (eAs[id]["settings"]["allow_toggle"]) {
                 ...
                 html += "<input id='edit_area_dark_checkbox_" + id + "' class='dark_" + id + "' type='checkbox' onclick='eAL.dark(\"" + id + "\");' accesskey='d' " + checked + " />";
                 html += "<label for='edit_area_dark_checkbox_" + id + "'>{$dark}</label></div>";
                 // Dark theme
             }
